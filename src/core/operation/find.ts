 ...
 */
export const find = (data: any[], query: ForerunnerQuery): any[] => {
...
export const findOne = (data: any[], query: ForerunnerQuery): any[] => {
	// Break query into operations
	const pipeline = queryToPipeline(query);
 ...
 * @returns {Array} The array of data that matched the passed query.
 */
export const findDeep = (data: any[], query: ForerunnerQuery): any[] => {
	return [];
};
