...
exports.operationLookup = exports.$updateReplaceMode = exports.$updateSetMode = exports.$or = exports.$and = exports.updateToPipeline = exports.queryToPipeline = exports.gateOperation = exports.reduceArray = exports.objectToArray = exports.genericOperation = exports.queryFromObject = void 0;
...
var gateOperation = function gateOperation(op, pipelineGenerator) {
...
var updateToPipeline = function updateToPipeline(query) {
  var currentGate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  var parentPath = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
...
var $and = gateOperation("$and", queryToPipeline);
exports.$and = $and;
var $or = gateOperation("$or", queryToPipeline); // Update gates

exports.$or = $or;
var $updateSetMode = gateOperation("$updateSetMode", updateToPipeline);
exports.$updateSetMode = $updateSetMode;
var $updateReplaceMode = gateOperation("$updateReplaceMode", updateToPipeline);
